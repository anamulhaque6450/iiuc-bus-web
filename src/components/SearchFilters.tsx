...
import { Search, Filter, Bus, Users, Calendar, MapPin, Route, X, Sparkles, Zap, ChevronDown, Clock, CheckCircle, AlertCircle } from 'lucide-react';
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 sm:mb-8 space-y-4 sm:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 text-xs sm:text-sm text-gray-500 bg-green-50 px-2 sm:px-3 py-1 sm:py-2 rounded-full border border-green-200 transition-all duration-300 hover:bg-green-100 hover:scale-105">
